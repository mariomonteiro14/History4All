        ...
        <v-card id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <b-img center class="d-block w-100" :src="getPatrimonioPhoto('8.jpg')" alt="First slide"/>
                </div>
                <div class="carousel-item">
                    <b-img center class="d-block w-100" :src="getPatrimonioPhoto('7.jpg')" alt="Second slide"/>
                </div>
                <div class="carousel-item">
                    <b-img center class="d-block w-100" :src="getPatrimonioPhoto('91.jpg')" alt="Third slide"/>
            </div>
            </div>
